              ...
              <div class="card-body">
                ...
                <div class="d-flex justify-content-center py-4">
                  <a href="/" class="logo d-flex align-items-center w-auto">
                    ...
                    <span class="d-none d-lg-block">Add Project Details</span>
                  </a>
                </div><!-- End Logo -->
                ...
                <form method="post" action="${twone}/project/create" modelAttribute="projectDto" class="row g-3 needs-validation" novalidate>
                  ...
                  <div class="col-12">
                    ...
                    <div class="invalid-feedback">프로젝트 명을 입력하세요</div>
                  </div>

                  <div class="col-12">
                    <label for="pKey" class="form-label">key</label>
                    <input type="text" name="projectKey" class="form-control" id="pKey" required>
                    <div class="invalid-feedback">키명을 입력해 주세요.</div>
                  </div>
